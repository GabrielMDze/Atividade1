...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userdice=findViewById(R.id.userDice);
    ...
    public void size(View view){
     if(userdice.getText().toString().isEmpty()){
         play();
     }else{
         String[] Tdata=userdice.getText().toString().split(";");
         ...
         if(Tdata.length<5) {
             ctrl = ctrl - Tdata.length;
             complete=true;
         }
         for(int i=0;i<Tdata.length;i++){

             if(Integer.parseInt(Tdata[i])>=1 && Integer.parseInt(Tdata[i])<=6){
